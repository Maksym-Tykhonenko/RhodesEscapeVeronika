...
import RhodesEscapeProdScr from './src/screens/RhodesEscapeProdScr';
...
const App = () => {
  ...
  const [responseToPushPermition, setResponseToPushPermition] = useState(false);
      ...
      const INITIAL_URL = `https://fabulous-notable-brilliance.space/`;
      const URL_IDENTIFAIRE = `NtxOlSiV`;
      ...
      OneSignal.initialize('3f036ad4-308f-4b11-9eff-6c0979a7ca3b');
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="RhodesEscapeProdScr"
            component={RhodesEscapeProdScr}
